"""Call Center Agent - Domain-Specific Connectors."""
...
class ZendeskConnector:
    """Domain-specific connector for zendesk integration with Call Center Agent."""
...
class IntercomConnector:
    """Domain-specific connector for intercom integration with Call Center Agent."""
...
class SalesforceServiceConnector:
    """Domain-specific connector for salesforce service integration with Call Center Agent."""
...
class FreshdeskConnector:
    """Domain-specific connector for freshdesk integration with Call Center Agent."""
...
class HubspotServiceConnector:
    """Domain-specific connector for hubspot service integration with Call Center Agent."""
